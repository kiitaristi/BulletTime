class GalleryLevel2 extends Phaser.Scene {
    constructor() {
        super("galleryLevel2");
        ...
        this.maxEnemyShoot = 16;      // amount of shooting enemies defeated to reach next level
        this.maxShootOnScreen = 4;      // don't have more than this many sprites on screen
        this.enemyShootPoints = 25;

        // create property inside "sprite" for dashing enemies
        this.my.sprite.enemyDash = [];
        this.maxEnemyDash = 45;         // amount of dashing enemies defeated to reach next level
        this.maxDashOnScreen = 2;         // don't have more that this many sprites on screen
        this.enemyDashPoints = 15;
        this.enemyDashSpeed = 13;
    ...
    update() {
        ...
        {
            this.scene.start("reset", {score: this.levelTwoScore});
        }
        ...
        if (this.shootMaxIter >= this.maxEnemyShoot && this.dashIter >= this.maxEnemyDash) {
            ...
            if (this.levelEndTimer >= 240) {
                this.scene.start("galleryLevelBoss", {score: this.levelTwoScore});
            }
        }
        ...
        for (let enemy of my.sprite.enemyDash) {
            for (let bullet of my.sprite.bullet) {
                if (this.collides(enemy, bullet)) {
                    ...
                    // Update score
                    this.levelTwoScore += this.enemyDashPoints;
                    this.updateScore();
        ...
        for (let enemy of my.sprite.enemyShoot) {
            ...
            for (let bullet of my.sprite.bullet) {
                if (this.collides(enemy, bullet)) {
                    ...
                    this.shootMaxIter++;
                    // Update score
                    this.levelTwoScore += this.enemyShootPoints;
                    this.updateScore();
                    // Have new enemy appear after end of animation
                }
            }
